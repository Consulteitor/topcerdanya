export const GUIDE_REDIRECTS = {
  ...
  // Canibalització: slug llarg → slug curt canònic
  "que-fer-a-la-cerdanya-guia-practica-i-realista-per-gaudir-ne-tot-lany": "/guies/que-fer-a-la-cerdanya",

  // URLs WordPress legacy → canònic curt directe (evita cadena de 2 redirects)
  "2022/12/02/que-hacer-en-la-cerdanya": "/guies/que-fer-a-la-cerdanya",

  // Slugs amb prefix ID (formats antics)
  "1593-on-dormir-cerdanya-amb-gos": "/guies/on-dormir-cerdanya-amb-gos",
  "1594-alojamiento-cerdanya-con-perro": "/guies/alojamiento-cerdanya-con-perro",
};
