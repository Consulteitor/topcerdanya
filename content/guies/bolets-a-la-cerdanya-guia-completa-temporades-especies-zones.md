...
- [Parc Natural del Cadí-Moixeró — web oficial](https://parcsnaturals.gencat.cat/ca/xarxa-de-parcs/cadi/gaudeix-del-parc/consells) — normativa, consells i accés al parc
- [Agents Rurals — Generalitat de Catalunya](https://interior.gencat.cat/ca/arees_dactuacio/agents-rurals/) — cos de vigilància del medi natural; en cas d'incidència al bosc, truca al **112**
- [Associació Boletaire Independent de Catalunya](https://associacioboletaireindependent.cat) — recursos d'identificació, fitxes d'espècies i comunitat boletaire
- En cas d'intoxicació per bolets: **urgències hospitalàries** o **112** — porta sempre mostres del que has menjat
